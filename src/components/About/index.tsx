...
function About() {
    ...
    return (
        <section
            ref={sectionRef}
            className='flex min-h-screen flex-wrap items-center justify-center gap-12 bg-white px-12 py-24 shadow-[0_0_3rem_3rem_var(--color-white)] md:px-24'
        >
            <div
                className={clsx(
                    'w-sm border-2 border-black bg-white p-4 opacity-0 not-dark:shadow-basic',
